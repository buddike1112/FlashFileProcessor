...
Future improvements: 
1.Integrate dummy Web API's and clients to handle some imaginary calls so validation process depends on Rules plus API call results 

2.Create technical documentation using open source designing tools.
