...
Version 1.0 (master) - This version will go do below activities
...
Future improvements: 1.Create Unit tests for the each process using NUnit or XUnit 2.Integrate dummy Web API's and clients to handle some imaginary calls so validation process depends on Rules plus API call results 3.Create technical documentation using open source designing tools.
